        ...
        <div class="container-fluid">
          <a class="navbar-brand p-0" href="index.html">
            ...
            <!-- <div class="site-title">
              <h3>Englishfrom.com</h3>
              <p class="tagline">MD Is Always Right</p>
            </div> -->
          </a>
          ...
          <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
            <ul class="navbar-nav ">
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="https://englishfrom.com/">Home</a>
              </li>
              <li class="nav-item">
         ...
         <a href="https://englishfrom.com/admin" target="_blank" class="btn btn-sm btn-info" >Login</a>  
      </nav>
      
      
      <section>
<ul class="bottom_links">
        <li><a href="about.html#roman">About Roman Letters</a></li>
        <li><a href="about.html#devanagari">About Devanagari</a></li>
        <li><a href="about.html#khmer">About Khmer</a></li>
        <li><a href="about.html#founder">About Founder </a></li>
        <!-- <li><a href="javascipt:;" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
          Khmer Script
        </a></li> -->
        <!--- <li><a href="#">Link</a></li>
        <li><a href="#">Link</a></li>
...
<section class="about_section ptb-60 border">
...
<style type="text/css">
    ...
    .ritz .waffle .s61 {
        ...
        text-align: left;
        color: #000000;
        font-family: "docs-Khmer Sangam MN", Arial;
        font-size: 10pt;
        vertical-align: bottom;
        white-space: nowrap;
        direction: ltr;
    ...
    .ritz .waffle .s54 {
        ...
        text-align: left;
        color: #000000;
        font-family: "docs-Khmer UI", Arial;
        font-size: 10pt;
        vertical-align: bottom;
        white-space: nowrap;
        direction: ltr;
    ...
    .ritz .waffle .s53 {
        ...
        text-align: center;
        color: #000000;
        font-family: "docs-Khmer OS", Arial;
        font-size: 10pt;
        vertical-align: bottom;
        white-space: nowrap;
        direction: ltr;
    ...
    .ritz .waffle .s58 {
        ...
        text-align: left;
        color: #000000;
        font-family: "docs-Khmer MN", Arial;
        font-size: 10pt;
        vertical-align: bottom;
        white-space: nowrap;
        direction: ltr;
...
<div class="p-4 bg-purple text-white text-center">
  ...
  <p>&copy COPYRIGHT 2024-2024. <a href="javascript:;" class="text-white text-uppercase">Englishfrom</a></p>
</div>
