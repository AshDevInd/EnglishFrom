               ...
               <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                            <label for="csv_file">Password</label>
                            <input type="password" name="data[password]" class="form-control" placeholder="Enter Password.." required
                            value="<?php if(isset($row)) { echo $row['password']; } ?>" />
                        </div>
                    </div>
                    </div>
                    <div class="row">
