      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <a class="btn btn-light btn-sm float-right text-dark" href='<?= base_url('admin/users/add') ?>'>
              ...
              <table id="example2" class="table table-bordered table-hover dataTable dtr-inline">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?=base_url('admin/users/edit/'.$v['id'])?>" class="btn btn-sm btn-info" >
